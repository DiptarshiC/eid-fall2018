...
def tempf(self):        
    with open('temp.csv', mode='w') as Temp:
        Writer = csv.writer(Temp, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)

        Writer.writerow([str(temp)])
        
def humf(self):        
    with open('hum.csv', mode='w') as Hum:
        Writer = csv.writer(Hum, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)

        Writer.writerow([str(hum)])

def tempf_avg(self):        
    with open('temp_avg.csv', mode='w') as Temp_avg:
        Writer = csv.writer(Temp_avg, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)

        Writer.writerow([str(temp_avg)])
        
def humf_avg(self):        
    with open('hum_avg.csv', mode='w') as Hum_avg:
        Writer = csv.writer(Hum_avg, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)

        Writer.writerow([str(hum_avg)])
        
def tempf_high(self):        
    with open('temp_high.csv', mode='w') as Temp_high:
        Writer = csv.writer(Temp_high, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)

        Writer.writerow([str(temp_high)])
        
def tempf_low(self):        
    with open('temp_low.csv', mode='w') as Temp_low:
        Writer = csv.writer(Temp_low, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)

        Writer.writerow([str(temp_low)])
        
def humf_high(self):        
    with open('hum_high.csv', mode='w') as Hum_high:
        Writer = csv.writer(Hum_high, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)

        Writer.writerow([str(hum_high)])        

def humf_low(self):        
    with open('hum_low.csv', mode='w') as Hum_low:
        Writer = csv.writer(Hum_low, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
